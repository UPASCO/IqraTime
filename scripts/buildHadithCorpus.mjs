...
// --- Theme tagging -------------------------------------------------------
// Shared with scripts/retagHadithThemes.mjs and scripts/extendHadithCorpus.mjs
// (see scripts/hadithThemes.mjs) so every entry is tagged by the same rule.
