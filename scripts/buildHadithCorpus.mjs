...
const catalogOut = {
  _readme:
    "Editorial catalog for the hadith corpus, generated by scripts/buildHadithCorpus.mjs. Entries were selected by MECHANICAL criteria only (translation length bounds, non-empty in Arabic/English/French/Bengali, no cross-reference stub, deduplicated). No religious or rhetorical judgement was applied. Every entry is therefore status=\"technically_verified\", never \"publishable\" — see docs/CORPUS.md.",
  entries: combined.map((c) => ({
    id: `${c.collection}:${c.hadithnumber}`,
