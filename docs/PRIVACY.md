...
All your preferences, history, and favorites stay on your device. IQRAnow
requires no account and does not send this data to any server.

## What IQRAnow does not do
...
policy, independent of IQRAnow's. The banking account that receives
