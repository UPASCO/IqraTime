...
export const en = {
  ...
  settings: {
    ...
    dailyNameToggle: "Name of Allah of the day",
    dailyNameDescription: "One of the 99 names with its meaning, once a day.",
    dailyDuaToggle: "Invocation of the day",
    dailyDuaDescription: "A short authentic invocation, once a day.",
    sectionLanguage: "Language",
    interfaceLanguage: "Interface language",
    translationLanguage: "Translation language",
    showArabic: "Show Arabic text",
    transliterationLabel: "Phonetics (transliteration)",
    transliterationDescription: "Show the pronunciation in Latin letters under the Arabic text — in the feed, on detail screens and in the Qur'an reader.",
    ...
    contentKindsDescription: "Choose what the feed and notifications rotate through — at least one.",
    contentKindAyah: "Verses (ayat)",
    contentKindHadith: "Hadiths",
    contentKindName: "Names of Allah",
  ...
  daily: {
    ...
    nameBannerLabel: "Name of the day",
  },
  names: {
    title: "99 Names of Allah",
    subtitle: "Al-Asma ul-Husna — one name to learn and live with each day.",
    dailyLabel: "Name of the day",
    positionLabel: "Name {number} of 99",
  },
  duas: {
    title: "Invocations",
    subtitle: "Authentic duas and adhkar for every moment of the day.",
    dailyLabel: "Invocation of the day",
    sourceLabel: "Source",
    englishFallbackNotice: "Not yet translated into your language — shown in English.",
    categories: {
      "daily-dua": "Daily duas",
      "morning-dhikr": "Morning adhkar",
      "evening-dhikr": "Evening adhkar",
      "dhikr-after-salah": "After the prayer",
      "quranic-dua": "Duas from the Quran",
