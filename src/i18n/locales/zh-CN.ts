...
export const zhCN: TranslationSchema = {
  ...
  settings: {
    ...
    vibration: "振动",
    jitter: "轻微随机偏移",
    dailyNameToggle: "每日真主尊名",
    dailyNameDescription: "99个尊名之一及其含义，每天一次。",
    dailyDuaToggle: "每日祈祷词",
    dailyDuaDescription: "一段简短的正统祈祷词，每天一次。",
    sectionLanguage: "语言",
    ...
    contentKindsDescription: "选择信息流与通知中轮换的内容——至少一项。",
    contentKindAyah: "经文",
    contentKindHadith: "圣训",
    contentKindName: "真主尊名",
    contentKindDua: "祈祷词",
    sectionSupport: "支持",
    diagnosticsLink: "诊断",
    sourcesLink: "来源与译文",
  ...
  daily: {
    bannerLabel: "每日经文",
    nameBannerLabel: "每日尊名",
  },
  names: {
    title: "真主的99个尊名",
    subtitle: "阿斯玛乌勒-胡斯纳——每天学习并体会一个尊名。",
    dailyLabel: "每日尊名",
    positionLabel: "第 {number} 个尊名（共99个）",
  },
  duas: {
    title: "祈祷词",
    subtitle: "适合一天中每个时刻的正统祈祷词与赞念。",
    dailyLabel: "每日祈祷词",
    sourceLabel: "来源",
    englishFallbackNotice: "尚未翻译成您的语言——以英文显示。",
    categories: {
      "daily-dua": "日常祈祷词",
      "morning-dhikr": "晨间赞念",
      "evening-dhikr": "晚间赞念",
      "dhikr-after-salah": "礼拜之后",
      "quranic-dua": "《古兰经》中的祈祷词",
      "selected-dua": "精选祈祷词",
    },
  },
  explore: {
